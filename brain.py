...
RAG_WARNING_PREFIX = (
    "Disclaimer: at least part of the response below was generated using experimental intent paths. "
    "Responses can be less accurate than those generated by requests for passage summaries, key words in a passage, "
    "and translation help for a specific passage. Please verify information where possible."
)
