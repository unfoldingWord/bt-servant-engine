...
Inputs:
- BSB verse JSONs in `sources/bsb/<stem>.json` (in this repo).
...
# Map TN/USFM book codes to BSB file stems under sources/bsb
...
def _load_bsb_book(stem: str, repo_root: Path) -> Tuple[Dict[VerseKey, str], Dict[VerseKey, str]]:
    ...
    """
    bsb_path = repo_root / "sources" / "bsb" / f"{stem}.json"
