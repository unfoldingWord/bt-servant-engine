...
INTENT_FOLLOWUP_QUESTIONS = {
    ...
    IntentType.CONSULT_FIA_RESOURCES: {
        "en": "Do you have another question about translation?",
        "es": "¿Tiene otra pregunta sobre traducción?",
        "fr": "Avez-vous une autre question sur la traduction?",
        "pt": "Tem outra pergunta sobre tradução?",
        "sw": "Je, una swali lingine kuhusu tafsiri?",
        "ar": "هل لديك سؤال آخر حول الترجمة؟",
        "hi": "क्या आपका अनुवाद के बारे में कोई अन्य प्रश्न है?",
        "zh": "您对翻译还有其他问题吗？",
        "ru": "У вас есть еще вопрос о переводе?",
        "id": "Apakah Anda memiliki pertanyaan lain tentang terjemahan?",
        "nl": "Heeft u nog een vraag over vertaling?",
    },
}
